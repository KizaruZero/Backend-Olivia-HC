...
export default function NifasSection() {
    ...
    return (
        <section
            id="fase-nifas"
            className="bg-white pb-12 pt-16 min-h-screen px-4 sm:px-6 lg:px-8"
        >
                        ...
                        <>
                            ...
                            <AnimatePresence mode="wait">
                                ...
                                >
                                    ...
                                    {activeTab === "leaflet" && (
                                        <div className="border-2 border-blue-400 border-dashed rounded-lg p-8 text-center">
                                            <svg
